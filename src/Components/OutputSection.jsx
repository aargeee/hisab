...
import { Hub, KeyRounded } from "@mui/icons-material";
...
function OutputSection(props) {
  ...
  useEffect(()=>{
    ...
    //console.log(toPay,personStatus.lender , personStatus.debter) ;
  } , [P1Expense , P2Expense] )
  ...
  function Manager(){
     ...
     calc.getTotalExpense(P1Expense , P2Expense , setTotalExpense) ; 
     calc.getCategoryAmount(setData , context2.user1List , context2.user2List , totalExpense) ;
     console.log(data) ;
